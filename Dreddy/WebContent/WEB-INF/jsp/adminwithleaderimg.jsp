            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                                <form:form  action="saveadminleaderimg.html"   modelAttribute="withleaderimggal" enctype="multipart/form-data"  method="post" onsubmit="return Validation();" onchange="return FormValidation();">
                                <div class="col-md-3">
	...
	<div class="gallery">
		...
		<div class="gallery-grids">
				...
				<div class="gallery-top-grids">
					...
					<c:forEach var="leaderimglist" items="${adminleaderimg}">
					<c:url var="deleteadminleaderimg" value="deleteadminleaderimg.html">
					<c:param name="gallery_id" value="${leaderimglist.gallery_id}"></c:param>
					<c:param name="gallery_img" value="${leaderimglist.gallery_img}"></c:param>
					</c:url>
					...
					<a href="${deleteadminleaderimg}"><i class="fa fa-trash" aria-hidden="true"></i></a>
						...
						<div class="gallery-grid">
							<a class="example-image-link" href="images/galleryimages/${leaderimglist.gallery_img}" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae cursus ligula">
								<img src="images/galleryimages/${leaderimglist.gallery_img}" alt="" />
