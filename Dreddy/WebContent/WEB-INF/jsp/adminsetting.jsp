...
<section id="main-content">
            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div>
                                <form:form method="post" action="saveadmin.html" modelAttribute="addnewadmin" onsubmit="return FormValidation();" onchange="return FormValidation();">
  ...
  <div class="panel panel-default">
    ...
    <c:url var="admindelete" value="admindelete.html">
