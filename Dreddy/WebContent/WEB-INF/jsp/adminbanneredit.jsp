...
<html>
<head>
<title>Dayananda reddy:: banneredit</title>
            ...
            <div class="col-md-12" id="bann">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div>
                               <form:form action="saveadminbanneredit.html" enctype="multipart/form-data"  method="post" modelAttribute="editadminbanner" onsubmit="return FormValidation();" onchange="return FormValidation();">
                               ...
                               <input type="hidden" name="bannerimgtoedit" value="${banimgtoedit}">
