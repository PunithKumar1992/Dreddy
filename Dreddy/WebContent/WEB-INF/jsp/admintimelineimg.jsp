...
<section class="wrapper">
            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                                <form:form  action="saveadmintimelineimg.html"   modelAttribute="timelineimggal" enctype="multipart/form-data"  method="post" onsubmit="return Validation();" onchange="return FormValidation();">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <form:option value="select"  disabled="" >Select Image Type</form:option>
	...
	<section class="wrapper">
		...
		<!-- gallery -->
	<div class="gallery">
		<h2 class="w3ls_head">Timeline Images</h2>
		<div class="gallery-grids">
				
				<div class="gallery-top-grids">
					
					<c:forEach var="timeimglist" items="${admintimeimg}">
					<c:url var="deleteadmintimeimg" value="deleteadmintimeimg.html">
					<c:param name="gallery_id" value="${timeimglist.gallery_id}"></c:param>
					<c:param name="gallery_img" value="${timeimglist.gallery_img}"></c:param>
					</c:url>
					<c:if test="${timeimglist.galleryimg_type=='TimeLine'}">
					<div class="col-sm-4 gallery-grids-left">
					<a href="${deleteadmintimeimg}" onclick="return confirmActiondelete();"><i class="fa fa-trash" aria-hidden="true"></i></a>
				
						<div class="gallery-grid">
							<a class="example-image-link" href="images/galleryimages/${timeimglist.gallery_img}" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae cursus ligula">
								<img src="images/galleryimages/${timeimglist.gallery_img}" alt="" />
