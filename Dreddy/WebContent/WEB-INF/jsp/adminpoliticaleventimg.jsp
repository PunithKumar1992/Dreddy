            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                                <form:form  action="saveadminpolticalimg.html"   modelAttribute="politicalimggal" enctype="multipart/form-data"  method="post" onsubmit="return Validation();" onchange="return FormValidation();">
                                <div class="col-md-3">
	...
	<div class="gallery">
		...
		<div class="gallery-grids">
				...
				<div class="gallery-top-grids">
					...
					<c:forEach var="poliimglist" items="${adminpoliticalimg}">
					<c:url var="deleteadminpoliticalimg" value="deleteadminpoliticalimg.html">
					<c:param name="gallery_id" value="${poliimglist.gallery_id}"></c:param>
					<c:param name="gallery_img" value="${poliimglist.gallery_img}"></c:param>
					</c:url>
					...
					<a href="${deleteadminpoliticalimg}"><i class="fa fa-trash" aria-hidden="true"></i></a>
						...
						<div class="gallery-grid">
							<a class="example-image-link" href="images/galleryimages/${poliimglist.gallery_img}" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae cursus ligula">
								<img src="images/galleryimages/${poliimglist.gallery_img}" alt="" />
