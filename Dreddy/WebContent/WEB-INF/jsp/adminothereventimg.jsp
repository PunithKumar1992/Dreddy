...
<section class="wrapper">
            ...
            <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div >
                                <form:form  action="saveadminothereventimg.html"   modelAttribute="othereventimggal" enctype="multipart/form-data"  method="post" onsubmit="return Validation();" onchange="return FormValidation();">
                                <div class="col-md-3">
	...
	<section class="wrapper">
		...
		<!-- gallery -->
	<div class="gallery">
		<h2 class="w3ls_head">With Leader Images</h2>
		<div class="gallery-grids">
				
				<div class="gallery-top-grids">
					
					<c:forEach var="otherimglist" items="${adminothereventimg}">
					<c:url var="deleteadminothereventimg" value="deleteadminothereventimg.html">
					<c:param name="gallery_id" value="${otherimglist.gallery_id}"></c:param>
					<c:param name="gallery_img" value="${otherimglist.gallery_img}"></c:param>
					</c:url>
					<c:if test="${otherimglist.galleryimg_type=='Other Events'}">
					<div class="col-sm-4 gallery-grids-left">
					<a href="${deleteadminothereventimg}" onclick="return confirmActiondelete();"><i class="fa fa-trash" aria-hidden="true"></i></a>
				
						<div class="gallery-grid">
							<a class="example-image-link" href="images/galleryimages/${otherimglist.gallery_img}" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae cursus ligula">
								<img src="images/galleryimages/${otherimglist.gallery_img}" alt="" />
