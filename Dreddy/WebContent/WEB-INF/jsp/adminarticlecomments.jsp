...
<html>
<head>
<title>Dayananda reddy:: Article comments</title>
...
<section id="main-content">
      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr>
            ...
            <th style="width: 22%;">Commenter Name</th>
            <th style="width: 22%;">Commenter Email</th>
 ...
 <c:forEach var="cmtlist" items="${admincmtlist}">
 <c:url var="delcmt" value="deleteadmincomment.html">
 <c:param name="commenter_id" value="${cmtlist.commenter_id}"></c:param>
 <c:param name="article_id" value="${cmtlist.article.article_id}"></c:param>
 
 </c:url>
        <tr>
           <td>${cmtlist.article.article_caption}</td>
           <td>${cmtlist.commenter_name}</td>
           <td>${cmtlist.commenter_email}</td>
           <td>${cmtlist.commenter_msg}</td>
          <td><a href="${delcmt}" onclick="return confirmActiondelete();"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
